        ...
        <div class="container hero-split">
            <div class="hero-text">
                ...
                <div class="hero-actions">
                    ...
                    <a href="<?= htmlspecialchars(($baseDirUrl ?: '') . '/tentang') ?>" class="btn tertiary">
    ...
    <section class="why-us-section" data-reveal>
        <div class="container">
            ...
            <div style="text-align: center; margin-top: 2.5rem;" data-reveal>
                <a href="<?= htmlspecialchars(($baseDirUrl ?: '') . '/tentang') ?>" class="btn secondary" style="display: inline-flex; align-items: center; gap: 0.5rem;">
    ...
    <section id="projects" class="home-projects-section" data-reveal>
        <div class="container">
            <div class="home-section-head">
                ...
                <a href="https://project.desadroid.shop" target="_blank" rel="noopener" class="home-view-all">
            ...
            <div class="plist-grid">
                ...
                <div class="plist-card" data-reveal>
                    <a href="<?= htmlspecialchars($detailUrl) ?>" target="_blank" rel="noopener" class="plist-card-thumb">
                    ...
                    <div class="plist-card-body">
                        <h3 class="plist-card-title"><a href="<?= htmlspecialchars($detailUrl) ?>" target="_blank" rel="noopener"><?= htmlspecialchars($project['title']) ?></a></h3>
                        ...
                        <div class="plist-card-footer">
                            <a href="<?= htmlspecialchars($detailUrl) ?>" target="_blank" rel="noopener" class="plist-btn-detail">
                            ...
                            <a href="<?= htmlspecialchars($project['link']) ?>" target="_blank" rel="noopener" class="plist-btn-live" title="Kunjungi Website Langsung">
    ...
    <section id="articles" class="home-articles-section" data-reveal>
        <div class="container">
            <div class="home-section-head">
                ...
                <a href="<?= htmlspecialchars(($baseDirUrl ?: '') . '/artikel') ?>" class="home-view-all">
            ...
            <div class="alist-grid">
                ...
                <?php
                    $articleUrl = ($baseDirUrl ?: '') . '/artikel/' . rawurlencode($article['slug']);
                ...
                <article class="alist-card" data-reveal>
                    ...
                    <div class="alist-card-body">
                        ...
                        <a href="<?= htmlspecialchars($articleUrl) ?>" class="alist-card-link">
                            ...
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"></polyline></svg>
                        </a>
                    </div>
                </article>
                <?php endforeach; ?>
                ...
                <div class="contact-details">
                    ...
                    <div class="detail-item">
                        ...
                        <div>
                            ...
                            <p><a href="https://wa.me/6289669709021" target="_blank" rel="noopener" style="color: var(--accent1); font-weight: 600;">+62 896 6970 9021</a></p>
                        </div>
                    </div>
                    <div class="detail-item">
                        <div class="detail-icon">
