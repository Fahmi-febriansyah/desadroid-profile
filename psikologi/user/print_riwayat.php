        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)): 
                    ...
                    $aspek_q = mysqli_query($koneksi, "SELECT a.nama_aspek FROM hasil_aspek ha JOIN aspek_hars a ON ha.id_aspek = a.id_aspek WHERE ha.id_konsultasi = $id_konsul AND ha.nilai_aspek >= 3 ORDER BY ha.nilai_aspek DESC");
                    $aspek_tinggi = [];
